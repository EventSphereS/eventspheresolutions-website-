...
export default function Footer() {
  return (
    <footer className="bg-[#1a0f40] text-white border-t border-white/5">
      <div className="w-full px-8 sm:px-12 lg:px-20 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-10 h-10 rounded-full flex items-center justify-center transition-colors hover:bg-[#E07B20] hover:text-white bg-white/10 text-white">
              ...
              <a href="https://wa.me/16028263834" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                className="w-10 h-10 rounded-full flex items-center justify-center transition-colors hover:bg-[#E07B20] hover:text-white bg-white/10 text-white">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about" className="hover:text-[#E07B20] transition-colors text-sm text-white/70">About Us</Link></li>
              ...
              <li><Link href="/playbook" className="hover:text-[#E07B20] transition-colors text-sm text-white/70">Playbook</Link></li>
              <li><Link href="/founding-partner" className="text-[#E07B20] font-semibold transition-colors text-sm">🏆 Founding Partner</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-semibold font-display mb-4 text-white">Contact</h4>
            <ul className="space-y-2">
              <li><a href="mailto:hello@eventspheresolutions.com" className="hover:text-[#E07B20] transition-colors text-sm text-white/70">hello@eventspheresolutions.com</a></li>
              <li><Link href="/contact" className="hover:text-[#E07B20] transition-colors text-sm text-white/70">Contact Us</Link></li>
            </ul>
          </div>
        </div>
